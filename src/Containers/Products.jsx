      ...
      <div className="flex flex-wrap -mx-4">
        <div className="w-full md:w-1/4 px-4 mb-4">
          <div className="bg-white shadow rounded p-4">
            ...
            <h2 className="font-bold mt-6 mb-4">Sort by</h2>
            <button
...
//               return (
//                 <label className="block cursor-pointer mb-2 text-sm text-gray-500 hover:text-indigo-500">
...
//             return <ProductBox key={index} {...product} imgHeight="h-60" />;
//           })}
//         </div>
//       </div>
//     </div>
